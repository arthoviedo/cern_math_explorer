...
\conferenceinfo{Joint Conference on Digital Libraries, JCDL'15}{June 21-25, 2015, Knoxville, TN, USA}
\CopyrightYear{2015} % Allows default copyright year (20XX) to be over-ridden - IF NEED BE.
\crdata{978-1-4503-3594-2/15/06 \\ http://dx.doi.org/10.1145/2756406.2756953}  % Allows default copyright data (0-89791-88-6/97/05) to be over-ridden - IF NEED BE.
...
\alignauthor Arthur Oviedo\\
  ...
  \affaddr{arthur.oviedo@alumni.epfl.ch}%
...
% \includegraphics[width=0.95\linewidth]{images/figures/input_interface.png}
...
\begin{minipage}{.55\textwidth}
  \includegraphics[width=0.95\linewidth]{images/figures/results_interface.png}
