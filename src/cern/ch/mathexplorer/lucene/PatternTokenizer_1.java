 ...
 * @see Pattern
 */
public final class PatternTokenizer_1 extends Tokenizer {
  ...
  public PatternTokenizer_1(Reader input, Pattern pattern, int group) {
    this(AttributeFactory.DEFAULT_ATTRIBUTE_FACTORY, input, pattern, group);
  }

  /** creates a new PatternTokenizer returning tokens from group (-1 for split functionality) */
  public PatternTokenizer_1(AttributeFactory factory, Reader input, Pattern pattern, int group) {
    super(factory, input);
    this.group = group;
