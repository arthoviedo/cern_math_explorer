...
\begin{longtable}{|m{4cm}|>{\centering\arraybackslash}m{2cm}|>{\centering\arraybackslash}m{1.65cm}|>{\centering\arraybackslash}m{1.65cm}|>{\centering\arraybackslash}m{1.65cm}|>{\centering\arraybackslash}m{1.65cm}|}
\hline 
Character Unicode Name & Visual Rendering & NFC & NFD & NFKC & NFKD \\ 
\hline 
