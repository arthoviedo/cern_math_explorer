...
The two functions that are more relevant for our work are {\codefont Simplify} and {\codefont FullySimplify} since they apply most of the other combined methods and do not require additional information.

Table \ref{table_simplifications} presents some sample equations found in some the documents in CDS and the different forms of simplification.
